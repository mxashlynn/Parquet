...
namespace Parquet.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to A RoomRecipe with {0} minimum walkable spaces exists, but rooms can only have from {1} to {2} walkable spaces..
        /// </summary>
        internal static string WarningRoomSize {
            get {
                return ResourceManager.GetString("WarningRoomSize", resourceCulture);
            }
        }
