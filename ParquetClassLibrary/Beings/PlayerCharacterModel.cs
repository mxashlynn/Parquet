...
namespace ParquetClassLibrary.Beings
{
    ...
    public sealed class PlayerCharacterModel : CharacterModel
    {
        ...
        /// <param name="inNativeBiome">The <see cref="ModelID"/> of the <see cref="Biome"/> in which this <see cref="PlayerCharacterModel"/> is most comfortable.</param>
        ...
        public PlayerCharacterModel(ModelID inID, string inName, string inDescription, string inComment,
