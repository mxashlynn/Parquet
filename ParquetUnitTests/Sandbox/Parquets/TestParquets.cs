...
namespace ParquetUnitTests.Sandbox.Parquets
{
    ...
    public static class TestParquets
    {
        ...
        public static readonly Floor TestFloor = new Floor(-All.FloorIDs.Minimum, "1 Floor Test Parquet");

        /// <summary>Used in test patterns in QA routines.</summary>
        public static readonly Block TestBlock = new Block(-All.BlockIDs.Minimum, "2 Block Test Parquet");

        /// <summary>Used in test patterns in QA routines.</summary>
        public static readonly Furnishing TestFurnishing = new Furnishing(-All.FurnishingIDs.Minimum, "3 Furnishing Test Parquet");

        /// <summary>Used in test patterns in QA routines.</summary>
        public static readonly Collectible TestCollectible = new Collectible(-All.CollectibleIDs.Minimum, "4 Collectible Test Parquet");
        #endregion
