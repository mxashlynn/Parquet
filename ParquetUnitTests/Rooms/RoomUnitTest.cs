...
namespace ParquetUnitTests.Rooms
{
    public class RoomUnitTest
    {
        ...
        private static readonly Room ValidRoom = new(TestWalkableArea, TestPerimeter);
        #endregion
        ...
        {
            var UncontainedPosition = new Point2D(TestPerimeter.Select(space => space.Position.X).Min() - 1,
